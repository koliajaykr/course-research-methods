...
# [:shallow_pan_of_food:cook<br>book:nerd_face:]{style="color:#000000"} {.big-text background-image="image/cookbook.jpg" background-size="cover" style="text-align: center"}
...
"provides a **quantitative description** of trends, attitudes, and opinions of population, or tests for **associations among variables** of a population, by studying a **sample** of that population"

## Survey Design Helps

- Descriptive Questions
  - *What percentage of students experience ragging in the higher education?*

- Questions about the relationships between variables
  - *Is there a positive association between the number of study hours and the marks obtained?*
  
- Questions about predictive relationships between variables over time
  - *Does number of study hours can predict the exam anxiety of the students?*

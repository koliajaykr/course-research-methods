...
## Tips: Designing the Sections of a Proposal[^14]
...
# [ethics]{style="color:#ffffff"} {.big-text background-image="image/ethics.jpg" background-size="contain" background-color="black"}

## Ethics & Research[^17]

[^17]: @sekaranResearchMethodsBusiness2016
...
## Ethical Issues in Research[^18]

[^18]: @creswellResearchDesignQualitative2018
...
# [cook<br>book]{style="color:#A51C30"} {.big-text background-image="image/cookbook.jpg" background-size="cover" style="text-align: center"}
...
## :plate_with_cutlery: A Good Introduction Addresses[^21]:

[^21]: @creswellResearchDesignQualitative2018

1. Establishing the problem leading to the study,

1. Reviewing the literature about the problem,

1. Identifying deficiencies in the literature about the problem,

1. Targeting an audience and noting the **significance of the problem** for this audience, and

1. Identifying the purpose of the proposed study.
...
"A question about the social world that is answered through the collection and analysis of first-hand, verifiable, empirical data."[^23]

[^23]: @chamblissMakingSenseSocial2018

## "Good" Research Question[^24]

[^24]: @chamblissMakingSenseSocial2018
...
## :mag::eyes: A new perspective or "angle" to the existing literature:[^26]
...
## :books: Purpose of Literature Review:
...
## :books: LR Sources {background-image="image/litref.png" background-size="contain" background-position="75%"}
...
## :sob: Literature Review Process[^27]...

[^27]: @creswellResearchDesignQualitative2018
...
## :hammer_and_wrench: Literature Review Tools
...
## [Connected Papers]{style="color:#A51C30"}

-   "A visual tool to help researchers and practitioners find and explore academic papers."[^28]

-   "Connected Papers uses a single, user-chosen **'origin paper'** to build a map of related research, based partly on overlapping citations. The service recently surpassed one million users"[^29]

-   Website: <https://www.connectedpapers.com/>

[^28]: Source <https://twitter.com/ConnectedPapers>

[^29]: Source <https://www.nature.com/articles/d41586-021-02346-4>
...
## [Open Knowledge Maps]{style="color:#A51C30"}
...
-   "**explain**s a certain phenomenon, ...

-   and the idea is that this explanation **will hold** in a wide range of settings."[^30]
...
By [Victor Vroom](https://www.sciencedirect.com/topics/social-sciences/expectancy-theory) (in 1964): "people will choose how to behave depending on the outcome they expect as a result of their behavior."

-   [**Expectancy Theory:**]{style="color:#A51C30"}[^31]
...
[^31]: @sekaranResearchMethodsBusiness2016
...
[^32]: @creswellResearchDesignQualitative2018
